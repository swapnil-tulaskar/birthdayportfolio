...
function Index() {
  ...
  return (
    <main className="relative min-h-screen">
      <Ambience />
      <MusicPlayer />
      <HeartBurst active={bursting} onDone={() => setBursting(false)} />
      ...
      <footer className="relative z-10 border-t border-border/40 px-5 py-12 text-center">
        <p className="font-script text-3xl text-rose-grad">Made With Endless Love ❤️</p>
        <p className="mt-2 font-display text-lg text-muted-foreground">By Your Loving Husband</p>
      </footer>
    </main>
  );
}
