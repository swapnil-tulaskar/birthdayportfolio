...
export function Gallery() {
  ...
  return (
    <section id="gallery" className="relative z-10 mx-auto max-w-6xl px-5 py-20 sm:py-28">
      <h2 className="text-center font-script text-4xl text-rose-grad sm:text-6xl">Love Gallery</h2>
      ...
      <div className="mt-12 columns-1 gap-4 sm:columns-2 lg:columns-3 [&>*]:mb-4">
        {photos.map((p, i) => (
          <button
            ...
            style={{ animationDelay: `${i * 120}ms`, boxShadow: "var(--shadow-soft)" }}
          >
            <div className="relative overflow-hidden rounded-2xl">
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: "inset 0 0 60px oklch(0.84 0.13 82 / 0.45)",
                }}
              />
      ...
      {open !== null && (
        <div
          className="fixed inset-0 z-[70] grid place-items-center px-4 py-16"
          style={{ background: "oklch(0.12 0.04 340 / 0.75)", backdropFilter: "blur(18px)" }}
        ...
        >
          <img
            ...
            style={{ boxShadow: "var(--shadow-glow)", userSelect: "none" }}
          />
          <div className="mt-6 flex items-center gap-4" onClick={(e) => e.stopPropagation()}>
            <button
              aria-label="Previous photo"
              onClick={() => setOpen((i) => ((i ?? 0) - 1 + photos.length) % photos.length)}
            ...
            <button
              ...
              onClick={() => setOpen((i) => ((i ?? 0) + 1) % photos.length)}
              className="glass rounded-full px-6 py-3 font-display text-lg transition hover:text-accent"
            >
              Next ›
            </button>
